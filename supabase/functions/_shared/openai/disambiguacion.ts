...
import { PRODUCTO_PENDIENTE_DISAMBIGUACION_ID } from "./linea-libre.ts";
import { resolverSeleccionCategoria } from "./resolver-categoria.ts";
import {
...
export function lineaPendienteDesdeAmbiguo(input: {
  ...
  cantidadTexto: string;
  unidad: "kg" | "pieza" | null;
}): LineaDisambiguada & { nombreMostrar: string } {
